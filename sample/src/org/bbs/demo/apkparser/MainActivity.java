...
//				parseApk(uri.toString(), true);
	...
	public static class TreeNodeFactory {
		public static TreeNode crateTreeNode(PackageInfoX info){
			...
			if (!arrayIsEmpty(info.permissions)){
				TreeNode useP = new TreeNode("permissions");
		...
		private static TreeNode createApplicationNode(PackageInfoX info) {
...
//		}
		...
		private static TreeNode createActivityNode(PackageInfoX.ActivityInfoX item) {
		...
		private static void parseComponent(TreeNode root, ComponentInfo item) {
		...
		private static void parsePackageItem(TreeNode root, PackageItemInfo item) {
		...
		static boolean hasSet(Object o){
		...
		static boolean arrayIsEmpty(Object[] array){
